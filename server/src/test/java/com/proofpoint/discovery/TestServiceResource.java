...
public class TestServiceResource
{
    ...
    protected void setUp()
    {
        ...
        resource = new ServiceResource(dynamicStore, staticStore, new NodeInfo("testing"), new DiscoveryEvents (new InMemoryEventClient(), new DiscoveryEventConfig().setEnabledEvents("")));
    }
